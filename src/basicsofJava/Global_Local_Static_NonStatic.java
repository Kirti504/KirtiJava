...
public class Global_Local_Static_NonStatic {
	...
	//Static can access static (method, global variable) - Exception is noneof the static methods can call main. But main can call all the static methods
	...
	public static void main(String[] args) {
		...
		Global_Local_Static_NonStatic.main(args = new String[3], args = new String[4]);
		main(args = new String[3], args = new String[4]);
		Kirti();
		Global_Local_Static_NonStatic.Kirti();
		int age = 35;
